...
#----------------S1 - Read Tempalate and Scanned Images------------------

base_dir = os.path.dirname(__file__)  # Gets the folder where your script is

#Read reference image
refFilename = os.path.join(base_dir, "images", "form.jpg") #to read from os
print("Reading reference image: ", refFilename)
im1 = cv2.imread(refFilename, cv2.IMREAD_COLOR)
im1 = cv2.cvtColor(im1, cv2.COLOR_BGR2RGB)

#Read image to be aligned
imFilename = os.path.join(base_dir, "images", "scanned-form.jpg")
...
#----------------S2 - Find keypoints in both Images---------------------
...
#------------------S3 - Match keypoints in the two image----------------
